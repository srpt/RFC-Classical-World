...
/************************************************************************************************/
	...
	int AI_getAttitudeCaliph(PlayerTypes ePlayer) const; // edead
	int AI_getAttitudeSharif(PlayerTypes ePlayer) const; // edead
	int AI_getAttitudeRaja(PlayerTypes ePlayer) const; // edead
...
/************************************************************************************************/
	...
	int  AI_getUnitAIModifier(UnitAITypes eUnitAI) const; 
	void AI_setUnitAIModifier(UnitAITypes eUnitAI, int iValue);
	int  AI_relicTradeVal(CvUnit* pUnit) const;
	// edead: end
...
protected:
	...
	int m_iMassacreProb;
	int m_iBuildPersecutorProb;
	int m_iWarDistanceModifier;
	int m_iWarCoastalModifier;
	int m_iMaxTakenTiles;
	int* m_aiUnitAIModifier; 
	// edead: end
