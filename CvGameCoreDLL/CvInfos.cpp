...
// edead: start
int CvPromotionInfo::getBarbarianPercent() const
{
	return m_iBarbarianPercent;
}

bool CvPromotionInfo::isCannotUpgrade() const
{
	return m_bCannotUpgrade;
}
// edead: end
...
void CvPromotionInfo::read(FDataStreamBase* stream)
{
	...
	// edead: start
	stream->Read(&m_iBarbarianPercent);
	stream->Read(&m_bCannotUpgrade);
	// edead: end
...
void CvPromotionInfo::write(FDataStreamBase* stream)
{
	...
	// edead: start
	stream->Write(m_iBarbarianPercent);
	stream->Write(m_bCannotUpgrade);
	// edead: end
...
bool CvPromotionInfo::read(CvXMLLoadUtility* pXML)
{
	...
	// edead: start
	pXML->GetChildXmlValByName(&m_iBarbarianPercent, "iBarbarianPercent");
	pXML->GetChildXmlValByName(&m_bCannotUpgrade, "bCannotUpgrade");
	// edead: end
...
bool CvUnitInfo::isKeepSubUnits() const
{
	return m_bKeepSubUnits;
}
...
void CvUnitInfo::read(FDataStreamBase* stream)
{
	...
	// edead: start
	stream->Read(&m_bRelic);
	stream->Read(&m_bPurgeReligion);
	stream->Read(&m_bAlwaysFullXP);
	stream->Read(&m_bKeepSubUnits);
	stream->Read(&m_iAutoPillageProb);
	 // edead: end
...
void CvUnitInfo::write(FDataStreamBase* stream)
{
	...
	// edead: start
	stream->Write(m_bRelic);
	stream->Write(m_bPurgeReligion);
	stream->Write(m_bAlwaysFullXP);
	stream->Write(m_bKeepSubUnits);
	stream->Write(m_iAutoPillageProb);
	// edead: end
...
bool CvUnitInfo::read(CvXMLLoadUtility* pXML)
{
	...
	// edead: start
	pXML->GetChildXmlValByName(&m_bRelic,"bRelic",false);
	...
	pXML->GetChildXmlValByName(&m_bKeepSubUnits,"bKeepSubUnits",false);
