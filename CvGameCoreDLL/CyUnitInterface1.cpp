...
void CyUnitPythonInterface1(python::class_<CyUnit>& x)
{
	...
	x
		...
		.def("isDelayedDeath", &CyUnit::isDelayedDeath, "bool ()") // edead
		.def("isAlwaysFullXP", &CyUnit::isAlwaysFullXP, "bool ()") // edead
		.def("setArtDefineTag", &CyUnit::setArtDefineTag, "void (std::string szNewValue)") // edead
