...
int CyPlot::getArtStyleType()
{
	return m_pPlot ? m_pPlot->getArtStyleType() : -1;
}

void CyPlot::setArtStyleType(int iNewValue)
{
	if (m_pPlot)
		m_pPlot->setArtStyleType((ArtStyleTypes) iNewValue);
}

int CyPlot::getFoundModifier(int eIndex)
{
	return m_pPlot ? m_pPlot->getFoundModifier((PlayerTypes) eIndex) : -1;
}

void CyPlot::setFoundModifier(int eIndex, int iNewValue)
{
	if (m_pPlot)
		m_pPlot->setFoundModifier((PlayerTypes) eIndex, iNewValue);
}
