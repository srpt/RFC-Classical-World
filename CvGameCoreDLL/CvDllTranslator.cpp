...
void CvDllTranslator::initializeTags(CvWString& szTagStartIcon, CvWString& szTagStartOur, CvWString& szTagStartCT, CvWString& szTagStartColor, CvWString& szTagStartLink, CvWString& szTagEndLink, CvWString& szEndLinkReplacement, std::map<std::wstring, CvWString>& aIconMap, std::map<std::wstring, CvWString>& aColorMap)
{
	...
	// edead: start
	aIconMap[L"[ICON_EGYPT]"] = std::wstring(1, (wchar)GC.getReligionInfo(RELIGION_EGYPT).getChar());
	aIconMap[L"[ICON_SUMER]"] = std::wstring(1, (wchar)GC.getReligionInfo(RELIGION_SUMER).getChar());
	...
	aIconMap[L"[ICON_PHOENICIA]"] = std::wstring(1, (wchar)GC.getReligionInfo(RELIGION_PHOENICIA).getChar());
	aIconMap[L"[ICON_ZOROASTRIANISM]"] = std::wstring(1, (wchar)GC.getReligionInfo(RELIGION_ZOROASTRIANISM).getChar());
	aIconMap[L"[ICON_JAINISM]"] = std::wstring(1, (wchar)GC.getReligionInfo(RELIGION_JAINISM).getChar());
	aIconMap[L"[ICON_TAOISM]"] = std::wstring(1, (wchar)GC.getReligionInfo(RELIGION_TAOISM).getChar());
	aIconMap[L"[ICON_BUDDHISM]"] = std::wstring(1, (wchar)GC.getReligionInfo(RELIGION_BUDDHISM).getChar());
	aIconMap[L"[ICON_CONFUCIANISM]"] = std::wstring(1, (wchar)GC.getReligionInfo(RELIGION_CONFUCIANISM).getChar());
	aIconMap[L"[ICON_HELLENISM]"] = std::wstring(1, (wchar)GC.getReligionInfo(RELIGION_HELLENISM).getChar());
	aIconMap[L"[ICON_CHRISTIANITY]"] = std::wstring(1, (wchar)GC.getReligionInfo(RELIGION_CHRISTIANITY).getChar());
	aIconMap[L"[ICON_MANICHAEISM]"] = std::wstring(1, (wchar)GC.getReligionInfo(RELIGION_MANICHAEISM).getChar());
	aIconMap[L"[ICON_SPICE_MERCHANTS]"] = std::wstring(1, (wchar)GC.getCorporationInfo(CORPORATION_SPICE_MERCHANTS).getChar());
	aIconMap[L"[ICON_CLOTH_MERCHANTS]"] = std::wstring(1, (wchar)GC.getCorporationInfo(CORPORATION_CLOTH_MERCHANTS).getChar());
	aIconMap[L"[ICON_GRAIN_MERCHANTS]"] = std::wstring(1, (wchar)GC.getCorporationInfo(CORPORATION_GRAIN_MERCHANTS).getChar());
	aIconMap[L"[ICON_FISH_MERCHANTS]"] = std::wstring(1, (wchar)GC.getCorporationInfo(CORPORATION_FISH_MERCHANTS).getChar());
	// edead: end
