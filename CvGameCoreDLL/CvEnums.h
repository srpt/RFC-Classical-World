...
enum CorporationTypes				// Exposed to Python
{
	...
	// edead: start
	CORPORATION_SPICE_MERCHANTS,
	CORPORATION_CLOTH_MERCHANTS,
	CORPORATION_GRAIN_MERCHANTS,
	CORPORATION_FISH_MERCHANTS,
	NUM_CORPORATIONS
	// edead: end
};
...
enum CivilopediaPageTypes		// Exposed to Python
{
	...
	//CIVILOPEDIA_PAGE_CONCEPT, // edead/srpt
	...
	//CIVILOPEDIA_PAGE_RELIC, // edead/srpt
	...
	//CIVILOPEDIA_PAGE_CONCEPT, srpt
	//CIVILOPEDIA_PAGE_CONCEPT_NEW, srpt
	CIVILOPEDIA_PAGE_HINTS,
	//CIVILOPEDIA_PAGE_CONCEPT_NEW, // edead/srpt
