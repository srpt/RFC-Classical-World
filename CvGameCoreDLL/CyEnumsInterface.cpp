...
void CyEnumsPythonInterface()
{
	...
	python::enum_<CivilopediaPageTypes>("CivilopediaPageTypes")
		...
		//.value("CIVILOPEDIA_PAGE_RELIC", CIVILOPEDIA_PAGE_RELIC) // edead/srpt
		...
		//.value("CIVILOPEDIA_PAGE_CONCEPT", CIVILOPEDIA_PAGE_CONCEPT)//srpt
		//.value("CIVILOPEDIA_PAGE_CONCEPT_NEW", CIVILOPEDIA_PAGE_CONCEPT_NEW)//srpt
