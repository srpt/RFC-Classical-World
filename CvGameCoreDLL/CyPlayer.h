...
public:
	...
	int  getBorders(int ePlayer) const;
	void setBorders(int ePlayer, int iNewValue);
	int  getAttitudeModifier(int ePlayer) const;
	void setAttitudeModifier(int ePlayer, int iNewValue);
	...
	void setGrowthPercent(int iNewValue);
	void setProductionPercent(int iNewValue);
	void setResearchPercent(int iNewValue);
	void setCulturePercent(int iNewValue);
	void setEspionagePercent(int iNewValue);
	void setGreatPeoplePercent(int iNewValue);
	void changeDistanceMaintenanceModifier(int iChange);
	void changeNumCitiesMaintenanceModifier(int iChange);
	void setReligionSpreadPercent(int /*ReligionTypes*/ eIndex, int iNewValue);
	int  AI_getCompactEmpireModifier() const;
	void AI_setCompactEmpireModifier(int iNewValue);
	int  AI_getMassacreProb() const;
	void AI_setMassacreProb(int iNewValue);
	int  AI_getBuildPersecutorProb() const;
	void AI_setBuildPersecutorProb(int iNewValue);
	int  AI_getWarDistanceModifier() const;
	void AI_setWarDistanceModifier(int iNewValue);
	int  AI_getWarCoastalModifier() const;
	void AI_setWarCoastalModifier(int iNewValue);
	int  AI_getMaxTakenTiles() const;
	void AI_setMaxTakenTiles(int iNewValue);
