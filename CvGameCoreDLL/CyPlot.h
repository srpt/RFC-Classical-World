...
public:
	...
	std::wstring getRegionName(bool bTooltip = false);
	int getArtStyleType();
	void setArtStyleType(int /*ArtStyleTypes*/ iNewValue);
	int getFoundModifier(int /*PlayerTypes*/ eIndex);
	void setFoundModifier(int /*PlayerTypes*/ eIndex, int iNewValue);
	// edead: end
