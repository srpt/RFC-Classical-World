...
/************************************************************************************************/
	...
	bool quickPillage();
	void setArtDefineTag(std::string szNewValue);
	int getBarbarianPercent() const;
	void changeBarbarianPercent(int iChange);
	void changeCannotUpgrade(int iChange);
	// edead: end
...
protected:
	...
	int m_iBarbarianPercent;
	bool m_bCannotUpgrade;
	// edead: end
