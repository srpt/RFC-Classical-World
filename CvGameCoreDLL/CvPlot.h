...
/************************************************************************************************/
	...
	CvWString getRegionName(bool bTooltip = false) const;
	void cameraLookAt();
	ArtStyleTypes getArtStyleType() const;
	void setArtStyleType(ArtStyleTypes eNewValue);
	int getFoundModifier(PlayerTypes eIndex) const;
	void setFoundModifier(PlayerTypes eIndex, int iNewValue);
	// edead: end
...
/************************************************************************************************/
	...
	// edead: start
	short m_iRegionID;
	short /*ArtStyleTypes*/ m_eArtStyleType;
	short* m_aiFoundModifier;
	// edead: end
