...
void CyPlotPythonInterface1(python::class_<CyPlot>& x)
{
	...
	x
		...
		.def("getRegionName", &CyPlot::getRegionName, "str (bool bTooltip)") 
		.def("getArtStyleType", &CyPlot::getArtStyleType, "int ()") 
		.def("setArtStyleType", &CyPlot::setArtStyleType, "void (int /*ArtStyleTypes*/ iNewValue)") 
		.def("getFoundModifier", &CyPlot::getFoundModifier, "int (int /*PlayerTypes*/ eIndex)") 
		.def("setFoundModifier", &CyPlot::setFoundModifier, "void (int /*PlayerTypes*/ eIndex, int iNewValue)") 		
		// edead: end
	;
}
