...
/************************************************************************************************/
	...
	int  getEspionagePercent() const;
	void setEspionagePercent(int iNewValue);
	int  getGreatPeoplePercent() const;
	void setGreatPeoplePercent(int iNewValue);
	int  getReligionSpreadPercent(ReligionTypes eIndex) const;
	void setReligionSpreadPercent(ReligionTypes eIndex, int iNewValue);
	int  getBorders(PlayerTypes eIndex) const;
	void setBorders(PlayerTypes eIndex, int iNewValue);
	int  getAttitudeModifier(PlayerTypes ePlayer) const;
	void setAttitudeModifier(PlayerTypes ePlayer, int iNewValue);
	bool isTurnPlayed() const;
	void setTurnPlayed(bool bNewValue);
	EraTypes getSoundtrackEra() const;
	// edead - end
	...
	DenialTypes AI_relicTrade(CvUnit* pUnit, PlayerTypes ePlayer) const; // edead (from Advanced Diplomacy by Afforess)
...
protected:
	...
	int m_iProductionPercent;
	int m_iResearchPercent;
	int m_iCulturePercent;
	int m_iEspionagePercent;
	int m_iGreatPeoplePercent;
	int m_iCompactEmpireModifier;
	int* m_paiReligionSpreadPercent;
	int* m_aiBorders;
	int* m_aiAttitudeModifier;
	bool m_bTurnPlayed;
	// edead - end
