...
def canTriggerHurricaneCity(argsList):
	...
	if not city.plot().getRegionID() in []:
		return false
...
def canTriggerHarbormasterDone(argsList):
	...
	#	return false
	iRoundship = CvUtil.findInfoTypeNum(gc.getUnitClassInfo, gc.getNumUnitClassInfos(), 'UNITCLASS_GALLEY')#srpt placeholder unit
	...
	if iShipsRequired > player.getUnitClassCount(iRoundship):
		return false
	# edead: end
